...
const Comment = () => {
  ...
  return (
    <div className="flex-1 pt-5 px-5 sm:pt-12 sm:pl-16 bg-blue-50/50">
      ...
      <div className="relative h-4/5 max-w-3xl overflow-x-auto scrollbar-none rounded-lg bg-white shadow ">
          <table className="w-full text-sm text-gray-500">
            ...
            <tbody>
              ...
              }).map((comment,index) => <CommentsTableData key={comment._id} comment={comment} index={index + 1} fetchComment={fetchComments}/>)}
            </tbody>
          </table>
      </div>
    </div>
